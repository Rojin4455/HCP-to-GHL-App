...
class GoHighLevelService:
    ...
    PIPELINE_ID = "eyOZONljHIaWwt6990Kf"
    ...
    def create_opportunity(self, location_id: str, contact_id: str, opportunity_data: Dict[str, Any]) -> Optional[str]:
        ...
        payload = {
            ...
            "name": f"Estimate #{opportunity_data.get('estimate_number', 'N/A')}",
    ...
    def update_opportunity(self, opportunity_id: str, opportunity_data: Dict[str, Any]) -> bool:
        ...
        if opportunity_data.get('invoice_number'):
            payload["name"] = f"Job #{opportunity_data['invoice_number']}"
    ...
    def _get_pipeline_stage_from_status(self, work_status: str) -> str:
        ...
        status_mapping = {
            'needs scheduling': self.PIPELINE_STAGES['quote_requested'],
            'scheduled': self.PIPELINE_STAGES['booking_confirmed'], 
            'in progress': self.PIPELINE_STAGES['booking_confirmed'],
            'complete unrated': self.PIPELINE_STAGES['service_sold'],
            'complete': self.PIPELINE_STAGES['service_sold'],
            'created job from estimate': self.PIPELINE_STAGES['service_sold'],
            'submitted for signoff': self.PIPELINE_STAGES['send_estimate_now'],
        }
        
        return status_mapping.get(work_status.lower(), self.PIPELINE_STAGES['new_leads'])
...
class HousecallProWebhookService:
    ...
    def process_webhook(self, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.ghl_service = GoHighLevelService(credentials.access_token)
    ...
    def _handle_estimate_created(self, webhook_data: Dict[str, Any], mapping: HCPToGHLMapping) -> Dict[str, Any]:
        ...
        return self._create_or_update_opportunity(estimate_data, customer_data, mapping, is_estimate=True)
    ...
    def _handle_job_created(self, webhook_data: Dict[str, Any], mapping: HCPToGHLMapping) -> Dict[str, Any]:
        ...
        return self._create_or_update_opportunity(job_data, customer_data, mapping, is_estimate=False)
    ...
    def _create_or_update_opportunity(self, opportunity_data: Dict[str, Any], customer_data: Dict[str, Any], 
        ...
        if is_estimate:
            hcp_estimate_id = opportunity_data.get('id')
